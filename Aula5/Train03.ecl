...
OUTPUT(myModel,,'~mymodelhmw',NAMED('TrainedModel'),OVERWRITE); //Replace XXX by your initials
...
featurerank := myLearner.FeatureImportance(myModel);
OUTPUT(featurerank, NAMED('FeatureImportance'));